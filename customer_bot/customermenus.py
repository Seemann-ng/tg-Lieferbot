...
reg_phone_menu = types.ReplyKeyboardMarkup(resize_keyboard=True, input_field_placeholder=REG_PHONE_MENU_PLACEHOLDER)
...
reg_location_menu = types.ReplyKeyboardMarkup(resize_keyboard=True, input_field_placeholder=REG_LOCATION_PLACEHOLDER)
...
main_menu = types.ReplyKeyboardMarkup(
    ...
    input_field_placeholder=MAIN_MENU_BTN
)
...
reset_info_menu = types.ReplyKeyboardMarkup(resize_keyboard=True, input_field_placeholder=RESET_CONTACT_INFO_BTN)
